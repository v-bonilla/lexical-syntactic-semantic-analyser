...
public class Scanner {
	...
	static {
		...
		literals.put("write", new Integer(5));
		literals.put("prompt", new Integer(6));
		literals.put("return", new Integer(7));
		literals.put("if", new Integer(8));
		literals.put("else", new Integer(9));
		literals.put("var", new Integer(10));
		literals.put("int", new Integer(11));
		literals.put("bool", new Integer(12));
		literals.put("chars", new Integer(13));
